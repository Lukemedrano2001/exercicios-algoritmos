...
public class JurosSimples {
	...
	public static double calculaJurosSimples(double capital, double taxa, int tempo, UnidadeTempo unidadeTempo) {
		double tempoEmAnos = converterParaAnos(tempo, unidadeTempo);
		double juros = (capital * taxa * tempoEmAnos) / 100;
	...
	public static String calculaMontante(double capital) {
		double juros = calculaJurosSimples(capital, 5, 122, UnidadeTempo.MES);
